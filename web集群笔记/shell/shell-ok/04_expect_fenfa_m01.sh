...
hostname m01
sed -i 's#HOSTNAME=oldboy#HOSTNAME=m01#' /etc/sysconfig/network
...
#将光盘中的程序包全部拷贝至/application/yum/centos6.6/x86_64/下
...
wget http://10.0.0.61/sersync_conf_2018-04-01.tar.gz
