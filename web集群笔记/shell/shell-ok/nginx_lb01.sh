...
#############################################################################################################################
hostname lb01
/bin/sed -i 's#HOSTNAME=backup#HOSTNAME=lb01#' /etc/sysconfig/network
/bin/sed -i 's#IPADDR=10.0.0.100#IPADDR=10.0.0.5#g' /etc/sysconfig/network-scripts/ifcfg-eth0
/bin/sed -i 's#IPADDR=172.16.1.100#IPADDR=172.16.1.5#g' /etc/sysconfig/network-scripts/ifcfg-eth1
cat >>/etc/hosts<<EOF
...
wget http://10.0.0.61/nginx-1.6.3.tar.gz
